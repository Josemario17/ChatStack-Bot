    ...
    return (
        <div className="w-full px-10 flex items-center justify-between">
            ...
            <ul className='w-auto flex items-center justify-between gap-8'>
                <Link to={"/"} className={`text-lg px-2 pb-2 border-b-2 ${pathUrl == "/" ? 'border-solid border-primary' : ''}`}>Chat</Link>
                <Link to={"/History"} className={`text-lg px-2 pb-2 border-b-2 ${pathUrl == "/History" ? 'border-solid border-primary' : ''}`}>Historico</Link>
                <Link to={"/Favorites"} className={`text-lg px-2 pb-2 border-b-2 ${pathUrl == "/Favorites" ? 'border-solid border-primary' : ''}`}>Favoritos</Link>
