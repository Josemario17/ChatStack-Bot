    ...
    return (
        <div className=" w-full px-10 flex items-center justify-between">
            ...
            <ul className='w-auto flex items-center justify-between gap-8'>
                ...
                <span className='ml-4 flex items-center text-white justify-between px-6 py-3 bg-primary rounded-2xl'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="size-6">
